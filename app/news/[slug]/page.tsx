...
// Interface update: Removed car and part, added brand
interface Article {
  _id: string;
  slug: string;
  title: string;
...
export default function NewsDetailPage() {
  ...
  }, [dispatch, slug, allArticles.length]);
  ...
  const relatedArticles = allArticles
    .filter((a: Article) => a._id !== article._id)
    .slice(0, 3);
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-8 pt-8 border-t border-slate-200 flex items-center justify-between">
                 <div className="flex items-center gap-4">
                    <span className="text-sm font-bold text-slate-900 uppercase tracking-wide">Share:</span>
